...
function makeCreateMarketInstruction({ connection, wallet, baseInfo, quoteInfo, lotSize, // 1
tickSize, // 0.01
...
export const createOpenBookMarket = (connection, token_owner, token_address, min_order_size = 1, tick_size = 0.01) => __awaiter(void 0, void 0, void 0, function* () {
