...
const buyToken = (
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const base_token = new raydium_sdk_1.Token(
        spl_token_1.TOKEN_PROGRAM_ID,
        token_address,
        token_info.decimals
      );
      const quote_info = global_1.EnvironmentManager.getQuoteTokenInfo();
      const quote_token = new raydium_sdk_1.Token(
        spl_token_1.TOKEN_PROGRAM_ID,
        quote_info.address,
        quote_info.decimal,
        quote_info.symbol,
      ...
      const base_token_amount = new raydium_sdk_1.TokenAmount(
        base_token,
        base_amount,
        false
      );
      const quote_token_amount = new raydium_sdk_1.TokenAmount(
        quote_token,
        quote_amount,
        false
      );
      const wallet_token_accounts = yield (0, utility_1.getWalletAccounts)(
        connection,
        buyer.publicKey
      );
