...
var sellToken = function (connection, buyer, token_address, base_amount, quote_amount, pool_key) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 2:
                ...
                base_token_amount = new raydium_sdk_1.TokenAmount(base_token, base_amount, false);
                quote_token_amount = new raydium_sdk_1.TokenAmount(quote_token, quote_amount === 0 ? 1 : quote_amount, quote_amount === 0 ? true : false);
