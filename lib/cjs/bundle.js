...
const createAndSendBundle = (connection, bundleTip, transactions, payer) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const searcher = (0, searcher_1.searcherClient)(
      global_1.EnvironmentManager.getJitoBlockEngine(),
      global_1.EnvironmentManager.getJitoKeypair()
    );
    ...
    for (let i = 0; i < transactions.length; i++) {
      ...
      (0, transaction_1.signTransaction)(
        transactions[i].signer,
        transactions[i].txn
      );
    ...
    try {
        ...
        (bundleResult) => {
          ...
          if (bundleResult.bundleId === bundleUUID) {
            ...
            if (bundleResult.rejected) {
              ...
              checked = true;
              if (
                ((_a = bundleResult.rejected.droppedBundle) === null ||
                _a === void 0
                  ? void 0
                  : _a.msg.includes('processed')) ||
                ((_c =
                  (_b = bundleResult.rejected.simulationFailure) === null ||
                  _b === void 0
                    ? void 0
                    : _b.msg) === null || _c === void 0
                  ? void 0
                  : _c.includes('processed'))
              ) {
                success = true;
              } else {
                success = false;
      ...
      if (success) return global_1.SPL_ERROR.E_OK;
      else return global_1.SPL_ERROR.E_FAIL;
    } catch (error) {
      console.error('Bundle Error: ', error);
